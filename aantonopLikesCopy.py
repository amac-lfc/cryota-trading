...
aantonopTweets = pd.read_csv('aantonopTweetsInfo.csv', usecols = colsList)
...
aantonop2021BTCLine = px.line(data_frame = allTimeBitcoin, title = 'Bitcoin Value by Date vs Aantonop likes', x = 'Date', y = 'Close')
